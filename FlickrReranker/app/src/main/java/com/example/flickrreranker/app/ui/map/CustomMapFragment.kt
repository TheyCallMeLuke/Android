package com.example.flickrreranker.app.ui.map
...
/**
 * A custom map fragment specialized for using in a scroll view. The purpose of this implementation
 * is to be able to scroll the map inside a scroll view, which by default, is not possible.
 */
